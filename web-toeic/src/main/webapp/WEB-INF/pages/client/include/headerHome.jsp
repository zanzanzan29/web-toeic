...
<!--HEADER ROW-->
  <div id="header-row">
    <div class="container">
      <div class="row">
              <!--LOGO-->
              <div class="span3"><a class="brand" href="<%=request.getContextPath()%>/home"><img src="${pageContext.request.contextPath}/resources/file/images/logotest.png" style="width: 200px; height: 200px" /></a></div>
              <!-- /LOGO -->
