...
<body>
	<!--HEADER ROW-->
	<div id="header-row" class="headerctucss">
		<div class="container">
			<div class="row">
				<!--LOGO-->
				<div class="span3">
					<a class="brand" href="/webtoeic"><img
						src="/webtoeic/resources/file/images/logotest.png" style="width: 121px; height: 95px" /></a>
				</div>
				<!-- /LOGO -->
					...
					<div class="navbar  pull-right">
						<div class="navbar-inner">
							...
							<div class="nav-collapse collapse navbar-responsive-collapse">
								<ul class="nav ulctucss">
									<c:if test="${pageContext.request.userPrincipal.name == null}">
										<li><a href="/webtoeic">Trang chủ</a></li>
										<li class="dropdown"><a href="#" class="dropdown-toggle droptt"
											data-toggle="dropdown">Luyện Tập <b class="caret"></b></a>
											<ul class="dropdown-menu ulnhocss">
