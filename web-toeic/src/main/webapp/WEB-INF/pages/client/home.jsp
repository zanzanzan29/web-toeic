  ...
  ==================================================-->
						...
						<div class="row">
							...
							<div class="span6">
								<div class="carousel-caption">
									<h1 style="color: #34447C; font-weight: 600;">Đào tạo chất lượng</h1>
									<p class="lead" style="color: #1a1a1a">Chúng tôi cung cấp cho các bạn những kiến
										thức tốt nhất.</p>
					...
					<div class="item">
						<div class="container">
							<div class="row">
								...
								<div class="span6">
									<div class="carousel-caption">
										<h1 style="color: #34447C; font-weight: 600;">${list.getSlidename()}</h1>
										<p class="lead" style="color: #1a1a1a">${list.getSlidecontent()}</p>
		...
		<div class="hometucss">
			<div>
				<h3>Từ Vựng</h3>
				<div class="chuatat">
					<c:forEach items="${listDataTV}" var="list" varStatus="loop">
						<div class="tungmuc">
...
==============================================-->
		...
		<div class="row feature-box khucgiuaxx">
		...
		<div class="row">
			...
			<div class="span4 tincayds">
				...
				<p align="justify">Mỗi năm, có hàng nghìn lượt học viên đã tham
					...
					là địa chỉ tin cậy của các bạn SV Bách Khoa,Sư Phạm Kinh tế, Xây dựng,
					Ngân hàng... và nhiều người đi làm trên địa bàn Đà Nẵng.</p>
