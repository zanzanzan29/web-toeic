...
<head>
	...
	<script src="<c:url value='/js/admin/quanlyBlog.js'/>"></script>
...
<div class="col-md-9 animated bounce">
	<h3 class="page-header">Quản lý Blog</h3>
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="titleModal">Thêm mới bài Blog</h4>
			</div>
			...
			<div class="modal-body">
				...
				<div class="row">
					...
					<div class="form-group col-md-6">
						...
						<input id="tieudebl" class="form-control">

					</div>

					<div class="form-group col-md-6">
						<label>Hình ảnh Blog</label>
						<input type="file" id="hinhanhbl" class="form-control" accept="image/*">
					</div>

					<div class="form-group col-md-12">
						<label>Mô tả:</label>
						<textarea cols="117" rows="4" id="mota"></textarea>
					</div>

					<div class="form-group col-md-12">
						<label for="markdown-editor">Chỉnh sửa nội dung bài Blog:</label>
			...
			<div class="modal-footer">
				...
				<button type="button" id="btnAddNewBlog" class="btn btn-primary">Xác nhận</button>
